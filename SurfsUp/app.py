...
# Make sure to use the correct path to your database file
database_path = database_path = r"C:\Users\preit\Downloads\Starter_Code (5)\Starter_Code\Resources\hawaii.sqlite"
